            ...
            if (phase !== PHASE_END && phase !== PHASE_CANCEL && !inMultiFingerRelease()) {
                ...
                if (
                    ...
                    if (
                        ...
                        validateDefaultEvent(jqEvent, (currentDirection = calculateDirection(currentFinger.last, currentFinger.end))),
        ...
        function touchEnd(jqEvent) {
            ...
            return (
                ...
                didSwipeBackToCancel() || !validateSwipeDistance()
                    ? triggerHandler(event, (phase = PHASE_CANCEL))
                    : options.triggerOnTouchEnd || (!1 === options.triggerOnTouchEnd && phase === PHASE_MOVE)
                    ? (!1 !== options.preventDefaultEvents && !1 !== jqEvent.cancelable && jqEvent.preventDefault(), triggerHandler(event, (phase = PHASE_END)))
                    : !options.triggerOnTouchEnd && hasTap()
                    ? triggerHandlerForGesture(event, (phase = PHASE_END), TAP)
                    : phase === PHASE_MOVE && triggerHandler(event, (phase = PHASE_CANCEL)),
        ...
        function triggerHandler(event, phase) {
            ...
            return (
                ...
                didDoubleTap() && !1 !== ret
                    ...
                    : didTap() && !1 !== ret && (ret = triggerHandlerForGesture(event, phase, TAP)),
                phase === PHASE_CANCEL && touchCancel(event),
                phase === PHASE_END && ((touches && touches.length) || touchCancel(event)),
                ret
            );
        }
