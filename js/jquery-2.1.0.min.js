/*! jQuery v2.1.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function (a, b) {
                    ...
                    return 1 === d && 0 === e
                        ...
                        : function (b, c, i) {
                              ...
                              if (q) {
                                  ...
                                  else for (; (l = (++n && l && l[p]) || (m = n = 0) || o.pop()) && ((h ? l.nodeName.toLowerCase() !== r : 1 !== l.nodeType) || !++m || (t && ((l[s] || (l[s] = {}))[a] = [u, m]), l !== b)); );
    ...
    var J = (o.access = function (a, b, c, d, e, f, g) {
        var h = 0,
            i = a.length,
            j = null == c;
        if ("object" === o.type(c)) for (h in ((e = !0), c)) o.access(a, b, h, c[h], !0, f, g);
        else if (
            void 0 !== d &&
            ((e = !0),
            o.isFunction(d) || (g = !0),
                ...
                for (
                    ...
                    (n = q = (h = Y.exec(b[j]) || [])[1]),
                        ...
                        n &&
                            ...
                            (m = i[n]) || (((m = i[n] = []).delegateCount = 0), (l.setup && !1 !== l.setup.call(a, d, p, g)) || (a.addEventListener && a.addEventListener(n, g, !1))),
            ...
            if (r && (i = r.events)) {
                for (j = (b = (b || "").match(E) || [""]).length; j--; )
                    if (((n = q = (h = Y.exec(b[j]) || [])[1]), (p = (h[2] || "").split(".").sort()), n)) {
                        for (l = o.event.special[n] || {}, m = i[(n = (d ? l.delegateType : l.bindType) || n)] || [], h = h[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), g = f = m.length; f--; )
                            (k = m[f]),
                                (!e && q !== k.origType) ||
                                    (c && c.guid !== k.guid) ||
        ...
        trigger: function (b, c, d, e) {
            ...
            if (
                ...
                3 !== d.nodeType &&
                    ...
                    (k = q.indexOf(":") < 0 && "on" + q),
                    ((b = b[o.expando] ? b : new o.Event(q, "object" == typeof b && b)).isTrigger = e ? 2 : 3),
                    (b.namespace = r.join(".")),
                ...
                for (f = 0; (g = p[f++]) && !b.isPropagationStopped(); )
                    (b.type = f > 1 ? i : n.bindType || q),
                        (l = (L.get(g, "events") || {})[b.type] && L.get(g, "handle")) && l.apply(g, c),
                        (l = k && g[k]) && l.apply && o.acceptData(g) && ((b.result = l.apply(g, c)), !1 === b.result && b.preventDefault());
                return (
                    (b.type = q),
                    e ||
                        ...
                        !o.acceptData(d) ||
                        (k && o.isFunction(d[q]) && !o.isWindow(d) && ((h = d[k]) && (d[k] = null), (o.event.triggered = q), d[q](), (o.event.triggered = void 0), h && (d[k] = h))),
                    b.result
                );
            }
        },
    ...
    function nb(a, b) {
        var c, d, e, f, g, h, i, j;
        if (1 === b.nodeType) {
            if (L.hasData(a) && ((f = L.access(a)), (g = L.set(b, f)), (j = f.events))) for (e in (delete g.handle, (g.events = {}), j)) for (c = 0, d = j[e].length; d > c; c++) o.event.add(b, e, j[e][c]);
    ...
    (ib.optgroup = ib.option),
        ...
        o.extend({
            clone: function (a, b, c) {
                ...
                if (!(l.noCloneChecked || (1 !== a.nodeType && 11 !== a.nodeType) || o.isXMLDoc(a))) for (g = ob(h), d = 0, e = (f = ob(a)).length; e > d; d++) pb(f[d], g[d]);
                if (b)
            ...
            buildFragment: function (a, b, c, d) {
                ...
                for (k.textContent = "", m = 0; (e = l[m++]); )
                    if ((!d || -1 === o.inArray(e, d)) && ((i = o.contains(e.ownerDocument, e)), (f = ob(k.appendChild(e), "script")), i && mb(f), c)) for (j = 0; (e = f[j++]); ) fb.test(e.type || "") && c.push(e);
                return k;
            },
            cleanData: function (a) {
                for (var b, c, d, e, f, g, h = o.event.special, i = 0; void 0 !== (c = a[i]); i++) {
                    if (o.acceptData(c) && (f = c[L.expando]) && (b = L.cache[f])) {
                        if ((d = Object.keys(b.events || {})).length) for (g = 0; void 0 !== (e = d[g]); g++) h[e] ? o.event.remove(c, e) : o.removeEvent(c, e, b.handle);
    ...
    function tb(a) {
        var b = m,
            c = rb[a];
        return (
            c || (("none" !== (c = sb(a, b)) && c) || ((b = (qb = (qb || o("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement))[0].contentDocument).write(), b.close(), (c = sb(a, b)), qb.detach()), (rb[a] = c)), c
        );
    }
    var ub = /^margin/,
    ...
    o.extend({
                ...
                return (
                    ...
                    void 0 === c
                        ? g && "get" in g && void 0 !== (e = g.get(a, !1, d))
                            ? e
                            : i[b]
                        : ("string" === (f = typeof c) && (e = Bb.exec(c)) && ((c = (e[1] + 1) * e[2] + parseFloat(o.css(a, b))), (f = "number")),
                          void (
                              null != c &&
                              c == c &&
        ...
        css: function (a, b, c, d) {
            ...
            return (
                ...
                (g = o.cssHooks[b] || o.cssHooks[h]) && "get" in g && (e = g.get(a, !0, c)),
                void 0 === e && (e = xb(a, b, d)),
                "normal" === e && b in Db && (e = Db[b]),
                "" === c || c ? ((f = parseFloat(e)), !0 === c || o.isNumeric(f) ? f || 0 : e) : e
            );
        },
    }),
    ...
    function Vb(a, b, c) {
        ...
        1 === a.nodeType &&
            ...
            ((c.overflow = [m.overflow, m.overflowX, m.overflowY]), "none" === (j = o.css(a, "display")) && (j = tb(a.nodeName)), "inline" === j && "none" === o.css(a, "float") && (m.display = "inline-block")),
        c.overflow &&
            ((m.overflow = "hidden"),
            k.always(function () {
        ...
        if (!o.isEmptyObject(l))
            for (d in (p ? "hidden" in p && (n = p.hidden) : (p = L.access(a, "fxshow", {})),
            f && (p.hidden = !n),
            n
                ? o(a).show()
                : k.done(function () {
        ...
        o.extend({
            ...
            removeAttr: function (a, b) {
                var c,
                    ...
                    e = 0,
                    f = b && b.match(E);
                if (f && 1 === a.nodeType) for (; (c = f[e++]); ) (d = o.propFix[c] || c), o.expr.match.bool.test(c) && (a[d] = !1), a.removeAttribute(c);
            },
            attrHooks: {
                type: {
                    set: function (a, b) {
    ...
    o.fn.extend({
        ...
        o.extend({
            ...
            prop: function (a, b, c) {
                ...
                if (a && 3 !== g && 8 !== g && 2 !== g)
                    return (
                        (f = 1 !== g || !o.isXMLDoc(a)) && ((b = o.propFix[b] || b), (e = o.propHooks[b])),
            ...
            return "boolean" == typeof b && "string" === c
                ...
                : this.each(
                      o.isFunction(a)
                          ...
                          : function () {
                                if ("string" === c) for (var b, d = 0, e = o(this), f = a.match(E) || []; (b = f[d++]); ) e.hasClass(b) ? e.removeClass(b) : e.addClass(b);
    ...
    o.fn.extend({
        val: function (a) {
            ...
            return arguments.length
                ...
                : e
                ? (b = o.valHooks[e.type] || o.valHooks[e.nodeName.toLowerCase()]) && "get" in b && void 0 !== (c = b.get(e, "value"))
                    ? c
    ...
    function rc(a) {
        return function (b, c) {
            ...
            if (o.isFunction(c)) for (; (d = f[e++]); ) "+" === d[0] ? ((d = d.slice(1) || "*"), (a[d] = a[d] || []).unshift(c)) : (a[d] = a[d] || []).push(c);
        };
    }
    function sc(a, b, c, d) {
        var e = {},
            ...
            ajax: function (a, b) {
                ...
                if (
                    ...
                    (k.dataTypes = o
                        ...
                        .match(E) || [""]),
                    null == k.crossDomain &&
                        ((h = mc.exec(k.url.toLowerCase())), (k.crossDomain = !(!h || (h[1] === ec[1] && h[2] === ec[2] && (h[3] || ("http:" === h[1] ? "80" : "443")) === (ec[3] || ("http:" === ec[1] ? "80" : "443")))))),
                    k.data && k.processData && "string" != typeof k.data && (k.data = o.param(k.data, k.traditional)),
                    sc(nc, k, b, v),
                    2 === t)
                )
                    return v;
                for (j in ((i = k.global) && 0 == o.active++ && o.event.trigger("ajaxStart"),
                (k.type = k.type.toUpperCase()),
                (k.hasContent = !kc.test(k.type)),
                (d = k.url),
                k.hasContent || (k.data && ((d = k.url += (dc.test(d) ? "&" : "?") + k.data), delete k.data), !1 === k.cache && (k.url = hc.test(d) ? d.replace(hc, "$1_=" + cc++) : d + (dc.test(d) ? "&" : "?") + "_=" + cc++)),
                ...
                for (j in ((u = "abort"), { success: 1, error: 1, complete: 1 })) v[j](k[j]);
                if ((c = sc(oc, k, b, v))) {
                    (v.readyState = 1),
                ...
                function x(a, b, f, h) {
                    ...
                    2 !== t &&
                        ...
                        (u = vc(k, u, v, j)),
                        j
                            ? (k.ifModified && ((w = v.getResponseHeader("Last-Modified")) && (o.lastModified[d] = w), (w = v.getResponseHeader("etag")) && (o.etag[d] = w)),
                              204 === a || "HEAD" === k.type ? (x = "nocontent") : 304 === a ? (x = "notmodified") : ((x = u.state), (r = u.data), (j = !(s = u.error))))
    ...
    (o.offset = {
        setOffset: function (a, b, c) {
            ...
            "static" === k && (a.style.position = "relative"),
                ...
                (f = o.css(a, "top")),
                (i = o.css(a, "left")),
                (j = ("absolute" === k || "fixed" === k) && (f + i).indexOf("auto") > -1) ? ((g = (d = l.position()).top), (e = d.left)) : ((g = parseFloat(f) || 0), (e = parseFloat(i) || 0)),
